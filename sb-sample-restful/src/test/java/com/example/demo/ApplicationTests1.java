...
public class ApplicationTests1 {
	...
	Logger logger = LoggerFactory.getLogger(ApplicationTests1.class);
	...
	public void setUp() throws Exception {
		mockMvc.perform(get("/v1/users/clear"));
	}
	...
	public void postUser() throws Exception {
		...
		mockMvc.perform(post("/v1/users/").params(params));
	...
	public void putUser() throws Exception {
		...
		mockMvc.perform(put("/v1/users/"+user.getId()).params(params));
